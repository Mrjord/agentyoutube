...
const CONFIG = {
  title: "47 patterns viraux. Tous explorables.",
  description:
    "Chaque pattern vient d'une vraie vidéo qui a surperformé. Explore la bibliothèque, vois le score viral de chaque structure, comprends pourquoi ça marche.",
    ...
    <div className="flex items-center justify-center p-4 sm:p-6 w-full not-prose">
      <div className="group relative w-full max-w-[420px] overflow-hidden rounded-[2rem] sm:rounded-[2.5rem] border bg-card p-1.5 sm:p-2 shadow-2xl shadow-primary/5 transition-all duration-500 hover:shadow-primary/10 hover:-translate-y-1">
        ...
        >
          ...
          <div className="pointer-events-none absolute inset-y-0 left-0 w-1/4 bg-linear-to-r from-background to-transparent z-20" />
          <div className="pointer-events-none absolute inset-y-0 right-0 w-1/4 bg-linear-to-l from-background to-transparent z-20" />
        </div>
