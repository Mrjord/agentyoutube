...
export default function LandingPage() {
  ...
  return (
    <div className="landing min-h-screen text-[#F5F0E8] relative z-[2]">
      ...
      {/* ── SOCIAL PROOF ─────────────────────────────────────────────── */}
      <section className="border-t border-b border-[#1F1F25] overflow-hidden">
        <div className="py-8">
          <FadeUp>
      ...
      {/* ── FEATURES ─────────────────────────────────────────────────── */}
      <section id="features" className="border-b border-[#1F1F25]">
        <div className="max-w-6xl mx-auto px-6 py-20">
      ...
      {/* ── FINAL CTA ────────────────────────────────────────────────── */}
      <section className="border-b border-[#1F1F25] relative overflow-hidden">
        {/* ambient */}
      ...
      {/* ── FOOTER ───────────────────────────────────────────────────── */}
      <footer className="border-t border-[#1F1F25] ">
